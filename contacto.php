    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?hl=en&amp;ie=UTF8&amp;ll=-11.9552328,-77.0685585&amp;spn=56.506174,79.013672&amp;t=m&amp;z=16&amp;output=embed"></iframe>
            </div>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    <li>
                        <a href="https://www.facebook.com/GuimarbotPeru"><i class="fa fa-facebook-square fa-2x" style="color:#286090"></i></a>
                    </li>
                    <li>
